...
The further K-mean cluster analysis result has divided all the LSOAs in East London according to the level of gentrification indicators. While Cluster 0 is identified with more intensed level of gentrification, Cluster 3 shows higher level of new constructions(labelled as "new-build gentrification").

<div style="text-align:center;">
   <img src="{{ '/assets/img/featuredwork/01-EL/01-Mapping.jpg' | prepend: site.baseurl }}" style="height:auto; object-fit: cover; width:80%; margin: 0 auto;">
</div>
