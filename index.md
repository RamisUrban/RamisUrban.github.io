...
<table>
	...
	<td style="text-align:center;vertical-align: top; height: 400px">
	  ...
	  <a href="{{ '/blog' | prepend: site.baseurl}}">
		<img src="{{ '/assets/img/featuredwork/Project01_Gen.jpg' | prepend: site.baseurl }}" 
			style="height:auto; object-fit: contain; width:auto; max-width:100%;"> 
		<font size=4> 
	...
	<td style="text-align:center;vertical-align: top;  height: 400px"><centre>
		...
		<img src="{{ '/assets/img/featuredwork/Project05_MUC.jpg' | prepend: site.baseurl }}" style="height:auto; object-fit: contain;width:auto; max-width:100%;"> <font size=4> Inside Out <br> <font size=2> Recalibrating Munich Metropolitan Region  
	<tr> 
